    ...
    return (
        <div className="w-full">
            ...
            <div className="tabst">
                ...
                <div>Total Income from Product</div>
            ...
            <div className="flex flex-col">
                {salesData.map((item, index) => {
                    const profit = item.sprice - item.buyingPrice; 
                    const totalIncome = item.sprice * item.quantitySold; 
                    return (
                        <div className="tabc" key={index}>
                            ...
                            <div>{profit * item.quantitySold}</div> {/* Total profit */}
                        </div>
                    );
                })}
            </div>
